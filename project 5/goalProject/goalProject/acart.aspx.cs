    ...
    public partial class cart : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["name"] != null)
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    {
                        // Creating Connection  
                        con = new SqlConnection("data source=  DESKTOP-56DD5MG\\SQLEXPRESS; database=goalProject; integrated security=SSPI");
                        con2 = new SqlConnection("data source=  DESKTOP-56DD5MG\\SQLEXPRESS; database=goalProject; integrated security=SSPI");
                        ...
                        while (sdr.Read())
                        {
                            ...
                            {
                                cartContainer.InnerHtml += $"<div class='cartBox' ><img class='productIMG'  src='{sdr[10]}' /> <span class='details'>{sdr[6]}</span class='details'> <span class='details'>qty:{sdr[4]}</span class='details'> <span class='details' style='text-decoration: line-through;'>{originalAfterQty} $</span> <span class='details'>{priceAfterQty} $</span> <a class='details' href='deleteCart.aspx?id={sdr[0]}'>delete</a><br/> </div>";
                            }
                            else
                            {
                                cartContainer.InnerHtml += $"<div class='cartBox' ><img class='productIMG'  src='{sdr[10]}' /> <span class='details'>{sdr[6]}</span class='details'><span class='details'>qty:{sdr[4]}</span class='details'> <span class='details' >{priceAfterQty} $</span> <a class='details' href='deleteCart.aspx?id={sdr[0]}'>delete</a><br/> </div>";
                            }
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con = new SqlConnection("data source =DESKTOP-56DD5MG\\SQLEXPRESS; database=goalProject; integrated security=SSPI");
                con2 = new SqlConnection("data source=  DESKTOP-56DD5MG\\SQLEXPRESS; database=goalProject; integrated security=SSPI");
                con3 = new SqlConnection("data source=  DESKTOP-56DD5MG\\SQLEXPRESS; database=goalProject; integrated security=SSPI");
                con4 = new SqlConnection("data source=  DESKTOP-56DD5MG\\SQLEXPRESS; database=goalProject; integrated security=SSPI");
