    ...
    public partial class addProduct : System.Web.UI.Page
    {
        ...
        public void uploadToDatabase(string srcP)
        {
            ...
            try
            {
                ...
                SqlCommand cm = new SqlCommand($"insert into product  (Book_id, name, description, category, price, imgSrc, discount, countINStock)values( '452','{TextBox1.Text}',   '{TextBox2.Text}'   ,    '{DropDownList1.SelectedItem.Value}', '{TextBox4.Text}',  'Images/products/{Path.GetFileName(FileUpload1.FileName)}' , '{TextBox6.Text}', '{TextBox7.Text}')", con);
                // Opening Connection  
                con.Open();
