			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-68col-12">
				<div class="form-group">
					<label for="eMail"  style=" margin:10px  " >Confirm password</label>
								...
								<asp:TextBox ID="TextBox6" runat="server" class="form-control"  placeholder="Enter Last name" TextMode="Password" ></asp:TextBox>
				</div>
			</div>
			<br /><br /><br /><br /><br />
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				...
				<br />
					...
					<asp:TextBox ID="TextBox5" runat="server" class="form-control"  placeholder="Enter first name" ></asp:TextBox>
