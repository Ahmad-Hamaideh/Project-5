        ...
        <div class="cont">
          ...
          <asp:TextBox ID="TextBox2"  runat="server" placeholder=" Password" TextMode="Password"></asp:TextBox>
            <br />
                ...
                <label></label>
                <br />
                <a id="registerId" runat="server" style="text-decoration:none; font-size:1.5rem;"><asp:Label ID="Label2" runat="server" Text=" Don't have an account? Register now "></asp:Label></a>
                <br />
